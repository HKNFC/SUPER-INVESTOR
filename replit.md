...
- **Institutional Score:** `institutional_score.py` computes a 0-100 Institutional Score from 5 sub-scores: Quality (ROIC/margins/leverage, 25%), Growth (revenue/earnings/margin expansion, 20%), Valuation (PEG/PE/PB, 15%), Momentum (3m/6m/12m returns/relative strength, 25%), Flow (MFI/OBV/volume ratio, 15%). Uses independent percentile ranking, winsorization, adaptive weighting for NaN. Categories: Elit 85+, Güçlü 70+, İzleme 55+, Zayıf <55.
